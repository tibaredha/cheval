...
html::munu('cheval',$controleur,'search'); 
...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="left">';
	...
	echo'</tr>';
		...
		{ 
			...
			$url1 = explode('/',$_GET['url']);if ($value['aprouve']==1){echo '<td align="center"><a  title="Désaprouvé cheval"        href="'.URL.$controleur.'/Aprouve/'.$value['id'].'/0/'.$url1[2].'/'.$url1[3].'" ><img src="'.URL.'public/images/ok.jpg"   width="16" height="16" border="0" alt=""   /></a></td>'; }else{echo '<td align="center"><a  title="Aprouvé cheval"        href="'.URL.$controleur.'/Aprouve/'.$value['id'].'/1/'.$url1[2].'/'.$url1[3].'" ><img src="'.URL.'public/images/non.jpg"   width="16" height="16" border="0" alt=""   /></a></td>';  }
			echo "<td align=\"left\"><a title=\"***\" href=\"".URL.$controleur."/***/".$value['id']."\" >".$value['NomA'].' ('.$value['Pere'].')'."</a></td> " ;
			echo '<td align="center" style="width:100px;">'.$value['N'].'</td>';
			// echo '<td align="center" ><input type="checkbox" value="'.$value['id'].'" name="id[]"></td>';
			...
			echo "<td align=\"left\"><a   title=\"Envoyer un e-mail\" href=\"".URL.$controleur."/mail/".$value['id']."\" >".HTML::nbrtostringv('eleveur','id',$value['ideleveur'],'NomP')."</td> " ;	
			echo '<td align="center" style="width:10px;" ><a target="_blank" title="Attestation D eleveur "  href="'.URL.'tcpdf/cheval/attestation.php?id='.$value['ideleveur'].'" ><img src="'.URL.'public/images/atestation.jpg"   width="20" height="20" border="0" alt=""   /></a></td>';
			echo '<td align="center" style="width:10px;" ><a target="_blank" title="Carte D eleveur "  href="'.URL.'tcpdf/cheval/Carteeleveur.php?id='.$value['ideleveur'].'" ><img src="'.URL.'public/images/carte.jpg"   width="20" height="20" border="0" alt=""   /></a></td>';
			...
			echo '<td align="center" bgcolor="lightblue" ><a  title="Editer signalement" href="'.URL.$controleur.'/createimage/'.$value['id'].'"  ><img src="'.URL.'public/images/'.$value['id'].'.jpg?t='.time().'"   width="20" height="20" border="0" alt=""   /></a></td>';
			echo '<td align="center" style="width:10px;" ><a target="_blank" title="Editer cheval"      href="'.URL.$controleur.'/edit/'.$value['id'].'" ><img src="'.URL.'public/images/upd.jpg"                       width="20" height="20" border="0" alt=""   /></a></td>';
			echo '<td align="center" style="width:10px;" ><a  title="Supprimer cheval"  href="'.URL.$controleur.'/delete/'.$value['id'].'" ><img src="'.URL.'public/images/del.jpg"                                     width="20" height="20" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
