...
<p id="ONDEEC1">ONDEEC</p>
	<form id="Canvas" name="formGCS"  action="<?php echo URL."dashboard/createbilan/".$this->user[0]['id'];  ?>"  method="POST"> 
		
		<fieldset id="fieldset1">
        <legend>Date </legend>
		<input  id="datebilan"   class="cheval"  type="TXT"  name="datebilan"  placeholder="00-00-0000"  autofocus/></br>
		
		</fieldset> 
		
		<fieldset id="fieldset1">
        <legend>Adresse </legend>
		 <?php HTML::WILAYAx('wbilan','wil','country','17000','Wilaya de Residence') ;HTML::COMMUNEx('cbilan','com','COMMUNEN','929','Commune de Residence') ;?>		<input  id="abilan"  class="cheval" type="text" name="adresse" placeholder="adresse"/></br>
		</fieldset>
		
		<fieldset id="fieldset1">
		<legend>Type d'examen:</legend>
		<?php
	    HTML::BILANx('tbilan','bilan','cheval','val',"Type d'examen") ;
	    ?>
		</fieldset>
		...
		<input  id="vbilan"  class="cheval" type="text" name="veterinaire" placeholder="Nom Du Veterinaire"/></br>
		</fieldset> 
...
<tr bgcolor="#00CED1"   >
<th style="width:10px;" colspan="8"   ><a title="Releve Des Tests de laboratoire"   href="<?php echo URL."tcpdf/cheval/certificatbil.php?id=".$this->user[0]['id'];?>">Releve Des Tests de laboratoire : </a></th>
