...
<div id="Canvas"  align="center">
		...
		<select id="selpen">    
			...
			<option value="lune">lung</option>
			<option value="luned">lund</option>
			<option value="epi">X_n</option>
			<option value="epiinf">X_i</option>
		    <option value="episup">X_s</option>
        ...
        <h4 id="prop1"><?php echo"Nom Du Proprietaire : ".HTML::nbrtostring('cheval','id',$url1[2],'ideleveur'); ?></h4>
...
HTML::Image(URL."public/images/logox.png?t=".time(), $width = 200, $height = 250, $border = -1, $title = -1, $map = -1, $name = -1, $class = 'image',$id='imagecanva3');
