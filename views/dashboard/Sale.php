	<h1>Changement de Propriétaire  : <?php echo  HTML::nbrtostring('cheval','id',$this->user[0]['id'],'NomA'); ?></h1><hr><br/>
   ...
   HTML::Image(URL."public/images/cheval/cr.jpg?t=".time(), $width = 200, $height = 250, $border = -1, $title = -1, $map = -1, $name = -1, $class = 'image',$id='imagecanva22');
	...
	?>
	</fieldset><p id="ONDEEC1">ONDEEC</p>
	<form id="Canvas" name="formGCS"  action="<?php echo URL."dashboard/createSale/".$this->user[0]['id'];  ?>"  method="POST"> 
		...
		<fieldset id="fieldset1">
        <legend>Ancien Proprietaire </legend>
	    <input  id="NomPAncien"  class="cheval" type="text" name="NomaP" placeholder="<?php echo  HTML::nbrtostring('eleveur','id',$this->user[0]['ideleveur'],'NomP'); ?>"/>
		</fieldset>
		<fieldset id="fieldset1">
        <legend>Nouveau Proprietaire</legend> 
	    <?php 
		HTML::WILAYAE('swilE','WILAYAE','WILAYAE','17000','Wilaya') ;
		HTML::WILAYAE1('swilE1','ideleveur','WILAYAE1','0','Proprietaire') ;
		?>
		</fieldset>
...
if (isset($this->userListview)) 
{
		...
		<td align="center" ><?php echo HTML::nbrtostring('eleveur','id',$value['ideleveur'],'wil');?></td>
		<td align="center" ><?php echo HTML::nbrtostring('eleveur','id',$value['ideleveur'],'com');?></td>
		<td align="center" ><?php echo HTML::nbrtostring('eleveur','id',$value['ideleveur'],'adresse');?></td>
		<td align="center" ><?php echo HTML::nbrtostring('eleveur','id',$value['ideleveur'],'NomP');?></td>
		<td align="center" bgcolor="lightblue"><a target="_blank" title="certificat <?php echo trim($value['ideleveur']).', '.trim($value['ideleveur'])?>'""   href="<?php echo URL."tcpdf/CHEVAL/certificatsale.php?id=".$value['id']."&idcheval=".$this->user[0]['id'];?>"><img src="<?php echo URL.'public/images/print.PNG';?>" width='16' height='16' border='0' alt=''/></a></td>
